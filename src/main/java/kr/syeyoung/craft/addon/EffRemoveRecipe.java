...
public class EffRemoveRecipe extends Effect {
    ...
    static {
        Skript.registerEffect(EffRemoveRecipe.class, "remove_trash_recipe %string% from %players%");
    }
    ...
    protected void execute(Event event) {
        ...
        for (String id : ids) {
            ...
            recipePlayers.forEach(p -> p.getAcquiredRecipes().remove(r));
        }
    }

    @Override
    public String toString(Event event, boolean b) {
        return "remove recipe effect with expression player: " + players.toString(event, b) + " and string epxression: "+recipeIds.toString(event,b);
    }
